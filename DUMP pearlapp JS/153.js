...
var module39 = require('./39'),
  module112 = globals.nativeQPLTimestamp || globals.nativePerformanceNow || require('./112'),
  n = {};
  ...
  return {
    ...
    startTimespan: function (o, p) {
      if (!this._timespans[o]) {
        ...
        n[o] = module39.beginAsyncEvent(o);
      }
    },
    stopTimespan: function (o) {
      var p = this._timespans[o];
      if (p && p.startTime) p.endTime || ((p.endTime = module112()), (p.totalTime = p.endTime - (p.startTime || 0)), module39.endAsyncEvent(o, n[o]), delete n[o]);
    },
    clear: function () {
      this._timespans = {};
      this._extras = {};
    ...
    markPoint: function (t, n) {
      if (!this._points[t]) this._points[t] = null != n ? n : module112();
    },
    getPoints: function () {
      return this._points;
    },
