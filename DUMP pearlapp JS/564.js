var regeneratorRuntime = require('regenerator-runtime'),
  ...
  p = (function () {
    function t(n) {
      ...
      this._pending = {};
      this._firestore = n;
      module505.SharedEventEmitter.addListener(module505.getAppEventName(this._firestore, 'firestore_transaction_event'), this._handleTransactionEvent.bind(this));
    }
    ...
    module8.default(t, [
      {
        ...
        value: function (t) {
          ...
          this._pending[s] = {
            meta: o,
            transaction: new module565.default(this._firestore, o),
          };
          return new Promise(function (t, u) {
            module510.getNativeModule(n._firestore).transactionBegin(s);
      ...
      },
      {
        key: '_remove',
        value: function (t) {
          module510.getNativeModule(this._firestore).transactionDispose(t);
            ...
            function (b) {
              for (;;)
                switch ((b.prev = b.next)) {
                  ...
                  case 23:
                    f._pendingResult = v;
                    return b.abrupt('return', module510.getNativeModule(this._firestore).transactionApplyBuffer(s, f._commandBuffer));
