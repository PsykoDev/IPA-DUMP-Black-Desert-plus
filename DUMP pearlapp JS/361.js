var module223 = require('./223'),
  ...
  t = module362.currentCentroidXOfTouchesChangedAfter,
  u = module362.currentCentroidYOfTouchesChangedAfter,
  s = module362.previousCentroidXOfTouchesChangedAfter,
  c = module362.previousCentroidYOfTouchesChangedAfter,
  p = module362.currentCentroidX,
  v = module362.currentCentroidY,
  h = {
      ...
      return {
        panHandlers: {
          ...
          onResponderGrant: function (s) {
            if (!t.handle) t.handle = module223.createInteractionHandle();
...
function l(o, t, u, s) {
  if (o.handle) {
    module223.clearInteractionHandle(o.handle);
    o.handle = null;
  }
