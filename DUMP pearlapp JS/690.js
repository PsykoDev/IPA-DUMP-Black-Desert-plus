var module691 = require('./691'),
  t = {};

for (var h in module691) module691.hasOwnProperty(h) && (t[module691[h]] = h);
...
u.rgb.keyword = function (h) {
  ...
  for (var b in module691)
    if (module691.hasOwnProperty(b)) {
      s = h;
      c = f;
      var f = module691[b],
...
u.ansi256.rgb = function (n) {
  if (module691 >= 232) {
    var t = 10 * (module691 - 232) + 8;
    return [t, t, t];
  }

  var h;
  module691 -= 16;
  return [(Math.floor(module691 / 36) / 5) * 255, (Math.floor((h = module691 % 36) / 6) / 5) * 255, ((h % 6) / 5) * 255];
};
