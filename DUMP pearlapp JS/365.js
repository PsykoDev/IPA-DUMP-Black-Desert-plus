var module7 = require('./7'),
  ...
  module18 = require('./18'),
  s = new module124(module366.default),
  f = new Map(),
  v = (function () {
    function t(n) {
      var l = this;
    ...
    module8.default(t, null, [
      {
        ...
        value: function (t) {
          module18(module366.default, 'PushNotificationManager is not available.');
      ...
      },
      {
        ...
        value: function (t) {
          ...
          module18(module366.default, 'PushNotificationManager is not available.');
          return module366.default.requestPermissions(module7);
        },
      },
      {
      ...
      },
      {
        ...
        value: function (t) {
          module18('function' == typeof t, 'Must provide a valid callback');
          module18(module366.default, 'PushNotificationManager is not available.');
