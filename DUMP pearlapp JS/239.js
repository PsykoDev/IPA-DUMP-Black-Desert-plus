  ...
  p = (function (p) {
    ...
    function b(s) {
      ...
      if (
        ...
        (V._useNativeDriver = module220(s)),
        ...
        var A = module240.fromBouncinessAndSpeed(null != (S = s.bounciness) ? S : 8, null != (U = s.speed) ? U : 12);
        ...
        var C,
          N,
          k = module240.fromOrigamiTensionAndFriction(null != (C = s.tension) ? C : 40, null != (N = s.friction) ? N : 7);
        V._stiffness = k.stiffness;
        V._damping = k.damping;
        V._mass = 1;
      }

      module18(V._stiffness > 0, 'Stiffness value must be greater than 0');
      module18(V._damping > 0, 'Damping value must be greater than 0');
      module18(V._mass > 0, 'Mass value must be greater than 0');
      return V;
    }
    ...
    module8(b, [
      ...
      },
      {
        key: 'stop',
        value: function () {
          module49(module13(b.prototype), 'stop', this).call(this);
          this.__active = false;
