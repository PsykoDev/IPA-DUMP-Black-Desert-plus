var module7 = require('./7'),
  ...
  u = (function () {
    function t(n) {
      ...
      this._messageId = this._messageId || module507.generatePushID();
      this._ttl = 3600;
    }
    ...
    module8.default(t, [
      ...
      },
      {
        ...
        value: function () {
          ...
          if (!module507.isObject(t)) throw new Error("RemoteMessage:setData expects an object but got type '" + typeof t + "'.");
          this._data = t;
          return this;
        },
      },
