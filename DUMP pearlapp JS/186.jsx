...
var C = module193(module192.UIView, {}),
  R = {
    transform: {
      diff: x,
    },
  ...
  module8(s, [
    {
      ...
      value: function () {
        var t = this.props;
        module18(this.context.isInSurface, 'ART: <Group /> must be a child of a <Surface />');
        return (
    ...
    module8(s, [
      {
        ...
        value: function () {
          var t = this.props,
            n = t.d || I(t.children),
            o = (n instanceof module188 ? n : new module188(n)).toJSON();
          return (
            <V
              fill={Q(t.fill, t)}
              opacity={M(t)}
  ...
  module8(s, [
    {
      ...
      value: function () {
        var module7 = o.font,
          module8 = I(o.children),
          o = this.props,
          u = o.path,
          l = u ? (u instanceof module188 ? u : new module188(u)).toJSON() : null,
          f = {
            font: lt(module7),
            lines: module8.split(ft),
          };
        return (
          <G
            fill={Q(o.fill, o)}
