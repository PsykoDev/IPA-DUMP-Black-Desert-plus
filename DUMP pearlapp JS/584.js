var module7 = require('./7'),
  ...
  u = (function () {
    function t(s, u, h) {
      if ((module7.default(this, t), !Object.values(module583.Importance).includes(h))) throw new Error('AndroidChannel() Invalid Importance: ' + h);
      this._channelId = s;
      this._name = u;
      this._importance = h;
    }
    ...
    module8.default(t, [
      ...
      },
      {
        ...
        value: function (t) {
          if (!Object.values(module583.Visibility).includes(t)) throw new Error('AndroidChannel:setLockScreenVisibility Invalid Visibility: ' + t);
