...
Object.keys(module689).forEach(function (t) {
  l[n.call(module689[t].labels).sort().join('')] = t;
});
var s = {};

function c(u, f) {
  if (!(this instanceof c)) return new c(u, f);
  if ((f && f in h && (f = null), f && !(f in module689))) throw new Error('Unknown model: ' + f);
  var v, p;
  ...
  if (null == u) {
    ...
    this.model = l[x];
    var j = module689[this.model].labels,
      A = [];
  ...
  if (s[this.model])
    for (p = module689[this.model].channels, v = 0; v < p; v++) {
...
function v(t, o, n) {
  (module685 = Array.isArray(module685) ? module685 : [module685]).forEach(function (t) {
    (s[t] || (s[t] = []))[o] = n;
  });
  module685 = module685[0];
  return function (h) {
    var l;

    if (arguments.length) {
      if (n) h = n(h);
      (l = this[module685]()).color[o] = h;
      return l;
    } else {
      l = this[module685]().color[o];
      if (n) l = n(l);
      return l;
    }
  };
...
c.prototype = {
  ...
  string: function (o) {
    var n = this.model in module685.to ? this : this.rgb(),
      h = 1 === (n = n.round('number' == typeof o ? o : 1)).valpha ? n.color : n.color.concat(this.valpha);
    return module685.to[n.model](h);
  },
  percentString: function (o) {
    var n = this.rgb().round('number' == typeof o ? o : 1),
      h = 1 === n.valpha ? n.color : n.color.concat(this.valpha);
    return module685.to.rgb.percent(h);
  },
  array: function () {
    return 1 === this.valpha ? this.color.slice() : this.color.concat(this.valpha);
  },
  object: function () {
    for (var t = {}, n = module689[this.model].channels, h = module689[this.model].labels, l = 0; l < n; l++) t[h[l]] = this.color[l];
  ...
  round: function (t) {
    module685 = (module685 || 0) ** 0;
    return new c(this.color.map(f(module685)).concat(this.valpha), this.model);
  },
  alpha: function (t) {
  ...
  b: v('lab', 2),
  keyword: function (t) {
    return arguments.length ? new c(t) : module689[this.model].keyword(this.color);
  },
  hex: function (o) {
    return arguments.length ? new c(o) : module685.to.hex(this.rgb().round().color);
  },
  rgbNumber: function () {
    var t = this.rgb().color;
...
Object.keys(module689).forEach(function (t) {
  if (-1 === h.indexOf(t)) {
    ...
    c.prototype[t] = function () {
      ...
      return new c(((n = module689[this.model][t].raw(this.color)), Array.isArray(n) ? n : [n]).concat(h), t);
    };
