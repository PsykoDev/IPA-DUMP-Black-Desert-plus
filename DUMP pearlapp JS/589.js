      ...
      if (s) {
        this._actions = s.actions
          ? s.actions.map(function (t) {
              return module581.fromNativeAndroidAction(t);
            })
          : [];
    ...
    module8.default(t, [
      {
        key: 'addAction',
        value: function (t) {
          if (!(t instanceof module581.default)) throw new Error("AndroidNotification:addAction expects an 'AndroidAction' but got type " + typeof t);
      ...
      },
      {
        ...
        value: function (t) {
          if (!Object.values(module583.BadgeIconType).includes(t)) throw new Error('AndroidNotification:setBadgeIconType Invalid BadgeIconType: ' + t);
      ...
      },
      {
        key: 'setCategory',
        value: function (t) {
          if (!Object.values(module583.Category).includes(t)) throw new Error('AndroidNotification:setCategory Invalid Category: ' + t);
          this._category = t;
          return this._notification;
        },
      },
      ...
      },
      {
        ...
        value: function (t) {
          if (!Object.values(module583.GroupAlert).includes(t)) throw new Error('AndroidNotification:setGroupAlertBehaviour Invalid GroupAlert: ' + t);
      ...
      },
      {
        key: 'setPriority',
        value: function (t) {
          if (!Object.values(module583.Priority).includes(t)) throw new Error('AndroidNotification:setPriority Invalid Priority: ' + t);
          this._priority = t;
          return this._notification;
        },
      },
