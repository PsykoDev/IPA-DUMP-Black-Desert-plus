      ...
      transform: [
        {
          translateX: f.interpolate({
            inputRange: [0, 1, 2],
            outputRange: module17.I18nManager.isRTL ? [-c, 0, s] : [s, 0, -c],
          }),
        },
      ],
    },
      ...
      transform: [
        {
          translateX: f.interpolate({
            inputRange: [0.5, 1, 2],
            outputRange: module17.I18nManager.isRTL ? [-R, 0, c] : [c, 0, -R],
          }),
        },
      ],
    },
      ...
      transform: [
        {
          translateX: f.interpolate({
            inputRange: [0, 1, 2],
            outputRange: module17.I18nManager.isRTL ? [-l.screen.width, 0, l.screen.width] : [l.screen.width, 0, -l.screen.width],
          }),
        },
      ],
    },
    ...
    s = [
      {
        translateX: n(
          ...
          inputRange: [0, 1, 2],
          outputRange: module17.I18nManager.isRTL ? [-l.width, 0, l.width] : [l.width, 0, -l.width],
        }),
      },
    ];
  return {
